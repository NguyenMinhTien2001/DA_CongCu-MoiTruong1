...
<link href="<c:url value='/templates/admin/css/sb-admin-2.min.css' />"
	rel="stylesheet" type="text/css">
...
<body id="page-top">
	...
	<script
		src="<c:url value='/templates/admin/js/demo/chart-area-demo.js' />"></script>
	<script
		src="<c:url value='/templates/admin/js/demo/chart-pie-demo.js' />"></script>
